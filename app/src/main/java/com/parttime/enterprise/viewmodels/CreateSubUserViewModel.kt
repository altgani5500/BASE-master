...
class CreateSubUserViewModel : ViewModel(), CoroutineScope {
    ...
    fun createSubUser(
        ...
        map.put("password", getRequestBody(pass))
        map.put("roleId", getRequestBody(roleid))
        ...
        val call: Call<CreateUserResponse> = apiService.addSubUserApi("Bearer $token", lang, map, bodyProfilePic)
