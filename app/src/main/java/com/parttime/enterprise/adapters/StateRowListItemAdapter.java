...
public class StateRowListItemAdapter extends RecyclerView.Adapter<StateRowListItemAdapter.MyHolder> {


    private final BaseActivity activity;
    private final List<String> mResources;
    private final LayoutInflater mLayoutInflater;
    private StateRowItemClick rowItemClick;


    public StateRowListItemAdapter(BaseActivity activity, List<String> mResources, StateRowItemClick clickListner) {
    ...
    private void removeItem(int position) {
        ...
        if (mResources.size() == 0) {
            rowItemClick.stateRowItemClick(position);
        }
    ...
    public interface StateRowItemClick {
        void stateRowItemClick(int pos);
    }
