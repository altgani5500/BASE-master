...
package com.parttime.enterprise.uicomman.locationaddress.services
...
import com.parttime.enterprise.uicomman.locationaddress.Constants
...
class FetchAddressIntentService : IntentService("FetchAddress") {
    ...
    override fun onHandleIntent(intent: Intent?) {
        ...
        if (addresses.isEmpty()) {
            ...
            /* val addressFragments1=ArrayList<String>()
             for(i in 0 until address.maxAddressLineIndex){
                 addressFragments1.add()
             }*/
