package com.parttime.enterprise.uicomman.enrollcalander.flexiblecalender.flexiblecalendar.view;
...
public class EventCountCellView extends BaseCellView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mEventCount > 0 && mPaint != null && mTextPaint != null) {
            ...
            canvas.drawText(String.valueOf(mEventCount), eventCircleX, mTextY+8, mTextPaint);
        }
    }
